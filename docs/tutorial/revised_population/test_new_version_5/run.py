...
##1) Set a calculator
#calc=Vasp(command='mpirun -np 32 vasp_std',xc='PBE',setups='recommended',lreal='Auto',algo='A',nelm=200,ediff=1e-5,lwave=False,lcharg=False,ismear=0,encut=500,sigma=0.01,ncore=32,directory='vasp')
calc = EMT()
